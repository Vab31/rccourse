...
export default function Premium() {
  ...
  <div class="flex flex-col text-center w-full mb-10">
    ...
    <div className="flex justify-center my-6">
        ...
        <button  className=" button inline-flex text-white  border-4 shadow-xl border-cyan-400 py-2 px-6 focus:outline-none hover:bg-red-600 rounded text-lg" style={{'backgroundColor':'rgb(211,0,0)'}}>
